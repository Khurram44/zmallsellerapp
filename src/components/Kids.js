  ...
  return (
    ...
    <View style = {{flex:1}}>
      ...
      <Tab.Navigator
        ...
        <Tab.Screen name="Babies and Toddlers" component={BNT} />
        <Tab.Screen name="Baby Care" component={BC} />

        <Tab.Screen name="Baby Gear and accessories" component={BGA} />
        <Tab.Screen
          name="Boys"
          component={Kidsboys}
          options={{tabBarLabel: 'Boys'}}
        />
        <Tab.Screen
          name="Girls"
          component={Kidsgirls}
