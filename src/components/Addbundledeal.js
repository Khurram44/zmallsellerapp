...
function Addbundledeal({navigation}) {
  const formTemplate = {
    data: [
      {
...

      {
        ...
        is_mandatory: 'true',
        meta: {
          title: 'Bundledeal Starting Date',
        },
      },
      {
        component: 'input-date',
    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.headerContainer}>
          ...
          />
          <Text style={styles.headerTitle}>Create Bundledeal</Text>
        </View>
