          ...
          <Modal.Body>
            {Filtertags.map(data => (
              <View style={styles.Vouchertypeholder}>
                <TouchableOpacity
                  onPress={() => {SetStatusfunc(data.name) ; ()=> navigation.navigate("Addvoucher", {name:"Status"})}}
                  style={[
             ...
             <TouchableOpacity onPress={()=> navigation.navigate("Addvoucher",{name:Status})} style = {{alignItems:'center',padding:10,backgroundColor:"#6ac2ff",borderRadius:10}}>
      ...
      <View style={{backgroundColor: '#eff0f4', flex: 1}}>
        <View style={styles.Buttonholder}>
          <TouchableOpacity
            ...
            <Text style={styles.Buttontext}>+ Create New Voucher</Text>
          </TouchableOpacity>
        </View>
      </View>
    </NativeBaseProvider>
