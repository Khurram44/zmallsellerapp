  ...
  return (
    ...
    <View style = {{flex:1}}>
      ...
      <Tab.Navigator
        ...
        <Tab.Screen name="Automobile" component={Automobile} />
        <Tab.Screen name="Edibles" component={Edible} />

        <Tab.Screen name="Home" component={Home} />
        <Tab.Screen
          name="Kitchen  AND dINING"
          component={Knd}
          options={{tabBarLabel: 'Kitchen  AND dINING'}}
        />
        <Tab.Screen
          name="Medical Supplies"
          component={Medicalsupplies}
          options={{tabBarLabel: 'Medical Supplies'}}
        />
        <Tab.Screen name="Office Accessories" component={Oa} />
        <Tab.Screen name="Sports ANd fitness" component={snf} />
        <Tab.Screen name="Travel And luggage" component={Tnl} />
